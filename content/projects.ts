...
export const projects: Project[] = [
 ...
 logo: "/images/logos/carrefour.svg",
 role: {
 en: "Technical Lead & Architect",
 es: "Technical Lead & Architect",
 },
 status: "current",
 featured: true,
 featuredWeight: 1,
 ...
 es: "Technical Lead & Architect en el ecommerce de Carrefour Argentina sobre VTEX IO: arquitectura retail multi-vertical a escala de producción. Regionalizador, split de carritos, mega menú y evolución de plataforma bajo alto tráfico.",
 },
 context: {
 en: "Carrefour Argentina is one of the country's leading supermarket chains, with a high-traffic omnichannel ecommerce on VTEX IO Store Framework. Public reporting around its digital channel has cited millions of monthly visits and a large order volume across hypermarkets, supermarkets, express, wholesale, pickup and marketplace. Inside Valtech I lead technical work on this platform: theme, 60+ custom VTEX IO apps, checkout, logistics and the commerce capabilities that keep grocery and non-food selling together, including coordination with the React Native app team.",
 es: "Carrefour Argentina es una de las cadenas de supermercados líderes del país, con un ecommerce omnicanal de alto tráfico sobre VTEX IO Store Framework. Comunicaciones públicas del canal digital han citado millones de visitas mensuales y un volumen alto de pedidos, cubriendo hiper, súper, express, mayorista, pickup y marketplace. Dentro de Valtech lidero el trabajo técnico sobre esta plataforma: theme, 60+ apps VTEX IO custom, checkout, logística y las capacidades commerce que hacen convivir grocery y non-food, incluyendo coordinación con el equipo de la app React Native.",
 },
 challenges: {
 en: [
 ...
 "Splitting the minicart by commerce segment so each group can checkout with its own minimums, shipping simulation and policies, including incompatibility rules (e.g. Quick Commerce vs scheduled purchase).",
 "Keeping Web (Store Framework + Checkout 6 custom) and the React Native app aligned on the same business domain while backends differ.",
 ...
 "Modernizar la selección de zona de entrega para que el shopper elija envío a domicilio, Drive o Quick Commerce antes de navegar, alineando región, seller y sales channel.",
 "Separar el minicart por segmento de commerce para que cada grupo pueda ir a checkout con sus mínimos, simulación de envío y políticas, incluyendo reglas de incompatibilidad (p. ej. Quick Commerce vs compra programada).",
 "Alinear Web (Store Framework + Checkout 6 custom) y la app React Native sobre el mismo dominio de negocio con backends distintos.",
 "Evolucionar un ecosistema grande de theme VTEX IO + apps custom sin interrumpir la operación diaria.",
 ],
 },
 contributions: {
 en: [
 "Technical leadership on architecture and solution design across the VTEX IO stack (theme, custom apps and BFFs).",
 "Mega menu: Admin-managed three-level category navigation for desktop and mobile, with segment-aware visibility (food / non-food).",
 ...
 "Cart split: minicart segmented into Supermarket, Home & Appliances and external sellers, with per-segment checkout, purchase minimums and incompatibility rules.",
 "Integrations and checkout workstreams: Checkout 6 customization, logistics, payments-related flows and Node BFFs that keep storefront and middleware in sync.",
 "Internal consultant to another Valtech team building the Carrefour React Native app: shared queries, business rules, flows and use cases so mobile stayed aligned with web commerce logic.",
 ...
 es: [
 "Liderazgo técnico en arquitectura y diseño de soluciones sobre el stack VTEX IO (theme, apps custom y BFFs).",
 "Mega menú: navegación de categorías de tres niveles administrable (desktop y mobile), con visibilidad por segmento (food / non-food).",
 "Regionalizador: flujo moderno de método de entrega y zona de servicio (envío a domicilio, Drive, Quick Commerce) que fija región, sellers y sales channel antes de comprar.",
 "Split de carritos: minicart segmentado en Supermercado, Hogar y Electro y sellers externos, con checkout por segmento, mínimos de compra y reglas de incompatibilidad.",
 "Integraciones y frentes de checkout: customización de Checkout 6, logística, flujos de pago y BFFs Node que mantienen storefront y middleware sincronizados.",
 "Consultor interno hacia otro equipo Valtech que construyó la app React Native de Carrefour: queries compartidas, reglas de negocio, flujos y casos de uso para alinear mobile con la lógica commerce de web.",
 ...
 logo: "/images/logos/medis.svg",
 logoMark: "/images/logos/medis-mark.svg",
 role: {
 en: "Technical Lead",
 es: "Technical Lead",
 },
 ...
 logo: "/images/logos/rouge.svg",
 logoMark: "/images/logos/rouge-mark.svg",
 sites: [
 {
 ...
 logo: "/images/logos/beauty24.svg",
 },
 {
 name: "Rouge Maison",
 url: "https://www.rougemaison.com.ar/",
 logo: "/images/logos/rougemaison.svg",
 },
 ],
 role: {
 en: "Technical Lead",
