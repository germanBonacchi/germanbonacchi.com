  ...
  },
  {
    ...
    points: {
      es: [
        ...
        "Alinear checkout con cart split, regionalizer y reglas multi-vertical cuando aplica.",
      ],
      en: [
        ...
        "Align checkout with cart split, regionalizer and multi-vertical rules when needed.",
      ],
      "pt-BR": [
        ...
        "Alinhar checkout com cart split, regionalizer e regras multi-vertical quando couber.",
      ],
      it: [
        ...
        "Allineare il checkout a cart split, regionalizer e regole multi-verticale quando serve.",
      ],
    },
    related: [
      {
